...
source("crowdfunding_valuation_1.1/db/db_info.R")
source("crowdfunding_valuation_1.1/data/crawling_data.R")
source("crowdfunding_valuation_1.1/data/model_data.R")
